...
<head>
    <meta charset="UTF-8">
    <title>Mantenimiento de Clientes y Productos</title>
...
<body>
    ...
    <main>
        <h1>Mantenimiento de Clientes y Productos</h1>    
        <p>Bienvenido al mantenimiento de clientes y productos (Acceso para Técnicos)</p>
